...
export default function ConfirmDialog({
  ...
  return (
    <div className="fixed inset-0 z-[220] flex items-center justify-center p-6">
      ...
      <div className="relative w-full max-w-md rounded-3xl bg-[var(--theme-card-bg)] border-[length:var(--theme-bw)] border-[var(--theme-border)] p-6 shadow-[10px_10px_0px_var(--theme-border)] space-y-5">
        <div>
          <h3 className="text-xl font-black t-italic">{title}</h3>
